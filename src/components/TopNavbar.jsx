        ...
        <header>
            <div className="container-fluid">
                <div className="d-flex my-3 px-4">
                    <div className="d-flex align-items-center">
                        <div className="icon-container d-flex align-items-center justify-content-center mr-3">
                            <svg role="img" height="16" width="16" aria-hidden="true"
                                className="Svg-sc-ytk21e-0 kcBZLg IYDlXmBmmUKHveMzIPCF" viewBox="0 0 16 16"
                                data-encore-id="icon">
                                <path
                        ...
                        <div className="icon-container d-flex align-items-center justify-content-center">
                            <svg role="img" height="16" width="16" aria-hidden="true"
                                ...
                                data-encore-id="icon">
                                <path
                                    d="M4.97.47a.75.75 0 000 1.06L11.44 8l-6.47 6.47a.75.75 0 101.06 1.06L13.56 8 6.03.47a.75.75 0 00-1.06 0z">
                                </path>
                            </svg>
                        </div>
                    </div>

                    <div className="profile d-flex align-items-center ml-auto" onClick={() => { setShowDropdown(!showDropdown) }}>
                        <div className="icon-container d-flex align-items-center justify-content-center">
                        ...
                        <div className="profile-name truncate2">
                            Username
                        </div>
                        <div className="mr-2 mb-1">
                            <svg role="img" height="16" width="16" aria-hidden="true"
                                className={showDropdown ? "Svg-sc-ytk21e-0 uPxdw eAXFT6yvz37fvS1lmt6k down-arrow rotate-icon" : "Svg-sc-ytk21e-0 uPxdw eAXFT6yvz37fvS1lmt6k down-arrow"} viewBox="0 0 16 16"
                                data-encore-id="icon">
                    ...
                    <ul className={showDropdown ? "dropdown-menu d-block" : "dropdown-menu d-none"}>
                        <li>
                            <div className="dropdown-item d-flex justify-content-between p-2">Account
                                <svg role="img" height="16" width="16" aria-hidden="true" aria-label="External link"
                                    viewBox="0 0 16 16" data-encore-id="icon" className="Svg-sc-ytk21e-0 uPxdw">
                                    <path
                        ...
                        <li>
                            <div className="dropdown-item p-2">Upgrade to Premium <svg role="img" height="16"
                        ...
                        <li>
                            <div className="dropdown-item p-2">Profile</div>
                        </li>
                        <li>
                            <div className="dropdown-item p-2">Settings</div>
                        </li>
                        <li>
                            <hr className="dropdown-divider" />
                        </li>
                        <li>
                            <div className="dropdown-item p-2">Log out</div>
                        </li>
                    </ul>
