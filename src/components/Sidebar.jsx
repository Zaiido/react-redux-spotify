...
const Sidebar = () => {
    ...
    return (
        <div id="nav-left" className="d-flex flex-column flex-shrink-0 p-3 text-white">
            <div className="text-white" style={{ cursor: "pointer" }}>
                <svg viewBox="0 0 1134 340" className="fwTMCeAaUoWDj9WcQbgy spotify-logo">
                    <title>Spotify</title>
            ...
            <ul className="nav nav-pills flex-column mb-2">
                <li className="nav-item">
                    <div className="nav-link text-white" aria-current="page">
                        <svg style={{ opacity: "1" }} role="img" height="24" width="24" aria-hidden="true"
                            className="Svg-sc-ytk21e-0 uPxdw home-active-icon mr-2" viewBox="0 0 24 24"
                            data-encore-id="icon">
                            <path
                ...
                <li className="nav-item">
                    {showSearchBar ?
                        <Form onSubmit={(e) => {
                            ...
                            <FormControl type="text" placeholder="Search" className="mr-sm-2 search-input" value={query} onChange={(e) => {
                        ...
                        <div className="nav-link text-white" onClick={() => {
                            ...
                            <svg role="img" height="24" width="24" aria-hidden="true"
                                className="Svg-sc-ytk21e-0 uPxdw search-icon mr-2 nav-image" viewBox="0 0 24 24" data-encore-id="icon">
                                <path
                ...
                <li className="nav-item">
                    <div className="nav-link text-white">
                        <svg role="img" height="24" width="24" aria-hidden="true"
                            className="Svg-sc-ytk21e-0 uPxdw collection-icon mr-2" viewBox="0 0 24 24" data-encore-id="icon">
                            <path
            ...
            <div className="nav-item mb-5 pb-4" style={{ cursor: 'pointer', marginTop: 'auto' }}>
                <svg role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon"
                    className="Svg-sc-ytk21e-0 uPxdw mr-2">
                    <path
